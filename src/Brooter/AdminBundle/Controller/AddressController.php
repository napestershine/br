...
class AddressController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $addresses = $em->getRepository('BrooterAdminBundle:Address')->findAll();
    ...
    {
        $address = new Address();
        $form = $this->createForm('Brooter\AdminBundle\Form\AddressType', $address);
    ...
    {
        $deleteForm = $this->createDeleteForm($address);
        $editForm = $this->createForm('Brooter\AdminBundle\Form\AddressType', $address);
