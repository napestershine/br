...
use Brooter\AdminBundle\Entity\Faq;
use Brooter\AdminBundle\Form\FaqType;
...
class FaqController extends Controller
{
    ...
    {
        $faq = new Faq();
        $form = $this->createForm('Brooter\AdminBundle\Form\FaqType', $faq);
    ...
    {
        $deleteForm = $this->createDeleteForm($faq);
        $editForm = $this->createForm('Brooter\AdminBundle\Form\FaqType', $faq);
