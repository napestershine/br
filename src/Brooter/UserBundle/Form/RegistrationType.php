        ...
        $builder
            ...
            ->add('plainPassword', LegacyFormHelper::getType('Symfony\Component\Form\Extension\Core\Type\RepeatedType'),
                array(
                    ...
                    'first_options' => array('label' => 'form.password', 'attr' => array('class' => 'single_form space_fix', 'placeolder' => 'Your Username'), 'label_attr' => array('class' => 'col-sm-2')),
                    'second_options' => array('label' => 'form.password_confirmation', 'attr' => array('class' => 'single_form space_fix', 'placeolder' => 'Your Username'), 'label_attr' => array('class' => 'col-sm-2')),
